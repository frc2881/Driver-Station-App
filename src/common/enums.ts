...
export enum Topic {
  ...
  RobotPose,
  FrontRightPoseSensorIsConnected,
  FrontRightPoseSensorHasTarget,
  FrontRightPoseSensorTargetCount,
  FrontLeftPoseSensorIsConnected,
  FrontLeftPoseSensorHasTarget,
  FrontLeftPoseSensorTargetCount,
  RearRightPoseSensorIsConnected,
  RearRightPoseSensorHasTarget,
  RearRightPoseSensorTargetCount,
